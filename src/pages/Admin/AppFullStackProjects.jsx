  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onRemove}
        className="text-red-500 hover:text-red-7
System: 00 hover:bg-red-50 dark:hover:bg-red-900/20 
...
export default function AppFullStackProjects() {
  ...
  useEffect(() => {
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        // Filter only AppFullStack projects
        const appFullStackProjects = projectsData.filter(project => project.title === "AppFullStack");
        setProjects(appFullStackProjects);
        setFilteredProjects(appFullStackProjects);
      },
      (error) => {
  ...
  const handleAdd = async (e) => {
    e.preventDefault();
    if (form.title !== "AppFullStack") {
      toast.error("Only AppFullStack project is allowed", {
        icon: <AlertCircle size={16} />,
      });
      return;
    }
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete the AppFullStack project? This action cannot be undone."))
      return;
    try {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                AppFullStack Project
              </h1>
              <p className="text-gray-600 dark:text-gray-400 mt-2">Manage your AppFullStack project</p>
            </div>
            ...
            >
              <Plus size={20} />
              {projects.length === 0 ? "Add AppFullStack Project" : "Add More AppFullStack Project"}
            </button>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-gray-700">
              <div className="flex flex-col lg:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="Search AppFullStack project details..."
                    value={searchTerm}
                  ...
                  <div className="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                        {editingProjectId ? "Edit AppFullStack Project" : "Add AppFullStack Project"}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400 mt-1">
                        {editingProjectId ? "Update AppFullStack project details" : "Create the AppFullStack project"}
                      </p>
                    </div>
                    <button
                      onClick={() => setShowModal(false)}
                  ...
                  <form onSubmit={handleAdd} className="mt-6 space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Describe the AppFullStack project in detail"
                        rows={4}
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 
                        rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent 
              ...
              {filteredProjects.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <div className="text-gray-400 dark:text-gray-500">
                    ...
                    <h3 className="text-lg font-medium mb-2">AppFullStack Project Not Found</h3>
                    <p className="text-sm">Coming soon! Add the AppFullStack project to get started.</p>
                  </div>
                </div>
              )}
            </div>
