...
//     setShowModal(true);
//     console.log("showModal set to true for edit");
//   };
...
//     resetForm();
//     setShowModal(true);
//     console.log("showModal set to true for add new project");
//   };
...
//                 Project Management
//               </h1>
//               <p className="text-gray-600 dark:text-gray-400 mt-2">Manage and organize your portfolio projects</p>
//             </div>
...
//                         {editingProjectId ? "Update project details" : "Create a new project for your portfolio"}
//                       </p>
//                     </div>
//                     <button
//                       onClick={(e) => {
...
//                               alt={project.title}
//                               className="w-16 h-16 object-cover rounded-lg shadow-md border border-gray-200 dark:border-gray-600"
//                             />
//                           )}
...
//                               <EditableCell
//                                 value={project.title}
//                                 onChange={(v) => handleUpdateField(project.id, "title", v)}
...
//                             onChange={(v) => handleUpdateField(project.id, "category", v)}
...
//                             ))
//                           ) : (
//                             <span className="text-gray-400 italic text-sm">No technologies</span>
//                           )}
...
//                                 target="_blank"
//                                 rel="noreferrer"
//                                 className="p-2 bg-green-100 dark:bg-green-900/30 text-green-700 
//                                 dark:text-green-400 rounded-lg hover:bg-green-200 dark:hover:bg-green-900/50 
...
//                                 target="_blank"
//                                 rel="noreferrer"
//                                 className="p-2 bg-gray-100 dark:bg-gray-700 text-gray-700 
//                                 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed
//                                 transition-all transform hover:scale-110 cursor-pointer"
//                               >
//                                 <Github size={16} />
//                               </button>
...
//                       <td className="px-6 py-6">
//                         <div className="flex items-center gap-2">
//                           <Tooltip text="Preview Project">
//                             <button
//                               onClick={() => project.demoLink && window.open(project.demoLink, "_blank")}
//                               disabled={!project.demoLink}
//                               className="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 
//                               dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/50 
//                               disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-110 cursor-pointer"
//                             >
//                               <Eye size={16} />
//                             </button>
//                           </Tooltip>
...
//                                 handleEdit(project);
//                               }}
//                               className="p-2 bg-amber-100 dark:bg-amber-900/30 text-amber-700 
//                               dark:text-amber-400 rounded-lg hover:bg-amber-200 dark:hover:bg-amber-900/50 
//                               transition-all transform hover:scale-110 cursor-pointer"
//                             >
//                               <Edit size={16} />
//                             </button>
...
//                               className="p-2 bg-red-100 dark:bg-red-900/30 text-red-700 
//                               dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-900/50 
//                               transition-all transform hover:scale-110 cursor-pointer"
//                             >
//                               <Trash2 size={16} />
//                             </button>
...
export default function AllProjects() {
  ...
  // Fetch projects from Firestore (including all project types)
  useEffect(() => {
    const unsub = onSnapshot(
      collection(db, "projects"),
      (snap) => {
        const projectsData = snap.docs.map((d) => ({ id: d.id, ...d.data() }));
        // Ensure all project types from the six files are included
        const allProjects = projectsData.filter((project) =>
          ["FrontendProjects", "BackendProjects", "FullStackProjects", "AppFrontend", "AppBackend", "AppFullStack"].includes(project.title)
        );
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      console.error(err);
      toast.error(`Operation failed: ${err.response?.data?.error?.message || err.message}`, { id: toastId });
    } finally {
      setIsUploading(false);
    }
  };
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          value={form.title}
                          onChange={handleChange}
                          placeholder="Enter project title (e.g., FrontendProjects)"
                          className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 
                          rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent 
                          dark:bg-gray-700 dark:text-white transition-all"
                          required
                      ...
                      <td className="px-6 py-6">
                        <div className="flex items-center gap-2">
                          ...
                          {project.codeLink && (
                            <Tooltip text="View Source Code">
                              <button
                                onClick={() => window.open(project.codeLink, "_blank")} // Fixed: Changed from demoLink to codeLink
