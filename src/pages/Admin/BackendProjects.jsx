...
export default function BackendProjects() {
  ...
  useEffect(() => {
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        // Filter only BackendProjects
        const backendProjects = projectsData.filter(project => project.title === "BackendProjects");
        setProjects(backendProjects);
        setFilteredProjects(backendProjects);
      },
      (error) => {
  ...
  const handleAdd = async (e) => {
    e.preventDefault();
    if (form.title !== "BackendProjects") {
      toast.error("Only BackendProjects is allowed", {
        icon: <AlertCircle size={16} />,
      });
      return;
    }
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete the BackendProjects? This action cannot be undone."))
      return;
    try {
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">Manage your BackendProjects</p>
            </div>
            ...
            >
              <Plus size={20} />
              {projects.length === 0 ? "Add BackendProjects" : "Add More BackendProjects"}
            </button>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-gray-700">
              <div className="flex flex-col lg:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="Search BackendProjects details..."
                    value={searchTerm}
                  ...
                  <div className="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                        {editingProjectId ? "Edit BackendProjects" : "Add BackendProjects"}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400 mt-1">
                        {editingProjectId ? "Update BackendProjects details" : "Create the BackendProjects"}
                      </p>
                    </div>
                    <button
                      onClick={() => setShowModal(false)}
                  ...
                  <form onSubmit={handleAdd} className="mt-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          value={form.category}
                          onChange={handleChange}
                          placeholder="e.g., API, Database, Server"
                          className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 
                          rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent 
                          dark:bg-gray-700 dark:text-white transition-all"
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Describe the BackendProjects in detail"
                        rows={4}
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 
                        rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent 
              ...
              {filteredProjects.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <div className="text-gray-400 dark:text-gray-500">
                    ...
                    <h3 className="text-lg font-medium mb-2">BackendProjects Not Found</h3>
                    <p className="text-sm">Coming soon! Add the BackendProjects to get started.</p>
                  </div>
                </div>
              )}
            </div>
