...
export default function AppFrontendProjects() {
  ...
  useEffect(() => {
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        // Filter only AppFrontend projects
        const appFrontendProjects = projectsData.filter(project => project.title === "AppFrontend");
        setProjects(appFrontendProjects);
        setFilteredProjects(appFrontendProjects);
      },
      (error) => {
  ...
  const handleAdd = async (e) => {
    e.preventDefault();
    if (form.title !== "AppFrontend") {
      toast.error("Only AppFrontend project is allowed", {
        icon: <AlertCircle size={16} />,
      });
      return;
    }
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete the AppFrontend project? This action cannot be undone."))
      return;
    try {
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">Manage your AppFrontend project</p>
            </div>
            ...
            >
              <Plus size={20} />
              {projects.length === 0 ? "Add AppFrontend Project" : "Add More AppFrontend Project"}
            </button>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-gray-700">
              <div className="flex flex-col lg:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="Search AppFrontend project details..."
                    value={searchTerm}
                  ...
                  <div className="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                        {editingProjectId ? "Edit AppFrontend Project" : "Add AppFrontend Project"}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400 mt-1">
                        {editingProjectId ? "Update AppFrontend project details" : "Create the AppFrontend project"}
                      </p>
                    </div>
                    <button
                      onClick={() => setShowModal(false)}
                  ...
                  <form onSubmit={handleAdd} className="mt-6 space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Describe the AppFrontend project in detail"
                        rows={4}
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 
                        rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent 
              ...
              {filteredProjects.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <div className="text-gray-400 dark:text-gray-500">
                    ...
                    <h3 className="text-lg font-medium mb-2">AppFrontend Project Not Found</h3>
                    <p className="text-sm">Coming soon! Add the AppFrontend project to get started.</p>
                  </div>
                </div>
              )}
            </div>
